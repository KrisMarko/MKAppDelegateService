...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Kris.Marko---ZhangYu/MKAppDelegateService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Kris.Marko---ZhangYu' => 'winzhyu@yeah.net' }
  s.source           = { :git => 'https://github.com/Kris.Marko---ZhangYu/MKAppDelegateService.git', :tag => s.version.to_s }
